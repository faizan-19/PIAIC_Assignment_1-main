...
function runTasks() {
    ...
    console.log(person_age > 18 || has_driving_license);
    var friends = ["Faizan", "Faizan", "Hassan", "Usman"];
    console.log("is Ahmad is in friends list?");
    console.log(friends.indexOf("Ahmad") != -1);
    console.log("is Faizan is in friends list?");
    console.log(friends.indexOf("Faizan") != -1);
    var marks = 80;
    ...
    var usernames = ["Faizan", "Faizan", "Hassan", "Usman", "admin"];
    ...
    var new_users = ["Faizan", "Hassan", "Ali", "hassan", "Zulqarnain"];
